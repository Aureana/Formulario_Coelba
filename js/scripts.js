...
const servidorSelect = document.querySelector("#servidor");

const CompanySelect = document.querySelector("#Company");
const SistOperacionallSelect = document.querySelector("#SistOperacional");
...
form.addEventListener("submit", (event) => {
  ...
  if (SistOperacionallSelect.value === "") {
    showModal("Por favor, selecione a sua situação");
    return;
  }
